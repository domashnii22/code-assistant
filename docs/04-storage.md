...
- **File**: `~/Library/Application Support/code-assistant/app-settings.json` (macOS)
  / `%APPDATA%\code-assistant\app-settings.json` (Windows) / `~/.config/code-assistant/app-settings.json` (Linux).
